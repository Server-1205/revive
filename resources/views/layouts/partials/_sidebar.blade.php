    ...
    <div class="widget-wrap">
        ...
        <div class="single-sidebar-widget instafeed-widget">
            ...
            <ul class="instafeed d-flex flex-wrap">
                <li><img src="{{ asset('img') }}/blog/instagram/i1.jpg" alt=""></li>
                <li><img src="{{ asset('img') }}/blog/instagram/i2.jpg" alt=""></li>
                <li><img src="{{ asset('img') }}/blog/instagram/i3.jpg" alt=""></li>
                <li><img src="{{ asset('img') }}/blog/instagram/i4.jpg" alt=""></li>
                <li><img src="{{ asset('img') }}/blog/instagram/i5.jpg" alt=""></li>
                <li><img src="{{ asset('img') }}/blog/instagram/i6.jpg" alt=""></li>
            </ul>
        </div>
            ...
            <div class="single-sidebar-widget post-category-widget">
                ...
                <ul class="cat-list mt-20">
                    ...
                    @foreach($categories as $category)
                        ...
                        <li>
                            <a href="{{ route('category', $category) }}" class="d-flex justify-content-between">
                                <p>{{ $category->title }}</p>
